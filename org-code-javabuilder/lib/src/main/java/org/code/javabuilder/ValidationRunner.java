...
public class ValidationRunner implements CodeRunner {
    ...
    public ValidationRunner(List<JavaProjectFile> validationFiles, List<JavaProjectFile> projectFiles, OutputAdapter outputAdapter) {
        this(validationFiles, projectFiles, new JavabuilderTestExecutionListener(outputAdapter, true), outputAdapter);
    }
