...
/**
 * This is the entry point for the lambda function. This should be thought of as similar to a main function, but with a specific input contract.
...
public class LambdaRequestHandler implements RequestHandler<Map<String,String>, String>{
  /**
   * This is the implementation of the long-running-lambda where user code will be compiled and executed.
   * @param lambdaInput A map of the json input to this lambda function. Input is formatted like this:
   *                    {
   *                         "queueUrl": <session-specific-url>,
   *                         "apiEndpoint": <environment-specific-url>,
   *                         "connectionId": <session-specific-string>,
   *                         "channelId": <project-specific-string>
   *                     }
