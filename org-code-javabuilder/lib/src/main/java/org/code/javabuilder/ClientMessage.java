 ...
 * generated by Javabuilder. Messages will use the following format: { "type":
 * <"ClientMessageType">, "value": <"second-level message data">, "detail": { <"optional":
 * "additional fields"> } } The "type" maps to an output type on the client side. The "value" will
 * be interpreted by a client library keyed on the given "type." The optional "detail" field allows
 * us to pass additional details to the client about the message. This allows us to handle
 * user-facing messages, exceptions, and program signals in distinct ways from the client-side.
 */
