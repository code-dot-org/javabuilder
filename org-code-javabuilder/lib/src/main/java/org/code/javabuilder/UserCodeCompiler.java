...
public class UserCodeCompiler {
  ...
  /**
   * @throws InternalError If the user's code has a compiler error or if we hit an internal
   *     exception that interferes with compilation.
   */
  public void compileProgram() throws InternalError, UserInitiatedException {
