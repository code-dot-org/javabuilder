...
public class PrompterTest {
  ...
  //    assertEquals(uploadUrl,
  // message.getValue().getDetail().get(ClientMessageDetailKeys.UPLOAD_URL));
  //  }
  //
  //  @Test
  ...
  // {
  //    when(fileManager.getUploadUrl(anyString())).thenReturn("url");
  //    when(inputHandler.getNextMessageForType(InputMessageType.THEATER)).thenReturn("other
  // message");
  //
  //    final Exception actual =
  //        assertThrows(InternalServerRuntimeError.class, () -> unitUnderTest.getImage("prompt"));
