...
class AudioUtilsTest {
  ...
  //              AudioUtils.readSamplesFromAssetFile(TEST_FILE_NAME);
  //            });
  //    assertEquals(SoundExceptionKeys.INVALID_AUDIO_FILE_FORMAT.toString(),
  ...
  //        .thenReturn(true);
  //    audioSystem
  //        .when(() -> AudioSystem.getAudioInputStream(any(AudioFormat.class),
  // eq(audioInputStream)))
  //        .thenReturn(audioInputStream);
  //
  ...
  // SoundExceptionKeys.INVALID_AUDIO_FILE_FORMAT.toString());
  //  }
  //
  //  @Test
