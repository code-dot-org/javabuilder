...
public class AssetUrlGenerator {
  ...
  private String getRequest(String url, HttpClient client) throws InternalRuntimeError {
    HttpRequest request =
    ...
    if (response.statusCode() > 299) {
      throw new InternalRuntimeError(InternalErrorKey.INTERNAL_EXCEPTION, new Exception(body));
    }
    return body;
  }
}
