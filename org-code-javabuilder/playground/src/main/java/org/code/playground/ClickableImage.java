...
public abstract class ClickableImage extends ImageItem {
    /**
     * Creates an item that can be displayed in the Playground and respond to click events. An item consists of an image,
     ...
     */
    public ClickableImage(String filename, int x, int y, int width, int height) throws FileNotFoundException {
